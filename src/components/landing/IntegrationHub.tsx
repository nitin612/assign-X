      ...
      <div className="relative min-w-[1080px] max-w-[1500px] mx-auto aspect-[1500/480]">
        ...
        >
          <div className="relative group">
            ...
            <div className="w-[108px] h-[108px] rounded-full bg-white dark:bg-[#111726] border-[10px] border-[#8263F7] shadow-xl shadow-[#8263F7]/25 flex items-center justify-center transition-transform duration-300 hover:scale-105 cursor-pointer relative z-10">
        ...
        <div
          ...
          style={{ left: '5%', top: '50%' }}
        >
          <div className="bg-white dark:bg-[#111726]/95 backdrop-blur-xs border border-slate-200 dark:border-slate-800/90 rounded-2xl px-3.5 py-2 inline-flex items-center gap-2 shadow-sm hover:shadow-md hover:scale-105 hover:border-[#8263F7] transition-all duration-200 cursor-pointer whitespace-nowrap">
        ...
        >
          <div className="bg-white dark:bg-[#111726]/95 backdrop-blur-xs border border-slate-200 dark:border-slate-800/90 rounded-2xl px-4 py-2.5 inline-flex items-center gap-2.5 shadow-sm hover:shadow-md hover:scale-105 hover:border-[#8263F7] transition-all duration-200 cursor-pointer whitespace-nowrap">
        ...
        >
          <div className="bg-white dark:bg-[#111726]/95 backdrop-blur-xs border border-slate-200 dark:border-slate-800/90 rounded-2xl px-4 py-2.5 inline-flex items-center gap-2.5 shadow-sm hover:shadow-md hover:scale-105 hover:border-[#8263F7] transition-all duration-200 cursor-pointer whitespace-nowrap">
            ...
            <span className="text-sm font-semibold text-slate-800 dark:text-slate-200">Jira Software</span>
          </div>
        </div>
        ...
        >
          <div className="bg-white dark:bg-[#111726]/95 backdrop-blur-xs border border-slate-200 dark:border-slate-800/90 rounded-2xl px-4 py-2.5 inline-flex items-center gap-2.5 shadow-sm hover:shadow-md hover:scale-105 hover:border-[#8263F7] transition-all duration-200 cursor-pointer whitespace-nowrap">
            ...
            <span className="text-sm font-semibold text-slate-800 dark:text-slate-200">Airtable</span>
          </div>
        </div>
        ...
        >
          <div className="bg-white dark:bg-[#111726]/95 backdrop-blur-xs border border-slate-200 dark:border-slate-800/90 rounded-2xl px-4 py-2.5 inline-flex items-center gap-2.5 shadow-sm hover:shadow-md hover:scale-105 hover:border-[#8263F7] transition-all duration-200 cursor-pointer whitespace-nowrap">
            ...
            <span className="text-sm font-semibold text-slate-800 dark:text-slate-200">Confluence</span>
          </div>
        </div>
        ...
        >
          <div className="bg-white dark:bg-[#111726]/95 backdrop-blur-xs border border-slate-200 dark:border-slate-800/90 rounded-2xl px-4 py-2.5 inline-flex items-center gap-2.5 shadow-sm hover:shadow-md hover:scale-105 hover:border-[#8263F7] transition-all duration-200 cursor-pointer whitespace-nowrap">
            ...
            <span className="text-sm font-bold text-slate-900 dark:text-slate-100">ClickUp</span>
          </div>
        </div>
        ...
        >
          <div className="bg-white dark:bg-[#111726]/95 backdrop-blur-xs border border-slate-200 dark:border-slate-800/90 rounded-2xl px-4 py-2.5 inline-flex items-center gap-2.5 shadow-sm hover:shadow-md hover:scale-105 hover:border-[#8263F7] transition-all duration-200 cursor-pointer whitespace-nowrap">
            ...
            <span className="text-base font-bold text-slate-900 dark:text-slate-100 tracking-tight">asana</span>
          </div>
        </div>
        ...
        >
          <div className="bg-white dark:bg-[#111726]/95 backdrop-blur-xs border border-slate-200 dark:border-slate-800/90 rounded-2xl px-4 py-2.5 inline-flex items-center gap-2.5 shadow-sm hover:shadow-md hover:scale-105 hover:border-[#8263F7] transition-all duration-200 cursor-pointer whitespace-nowrap">
            ...
            <span className="text-sm font-bold text-slate-900 dark:text-slate-100">Notion</span>
          </div>
        </div>
        ...
        >
          <div className="bg-white dark:bg-[#111726]/95 backdrop-blur-xs border border-slate-200 dark:border-slate-800/90 rounded-2xl px-3.5 py-2 inline-flex items-center gap-2 shadow-sm hover:shadow-md hover:scale-105 hover:border-[#8263F7] transition-all duration-200 cursor-pointer whitespace-nowrap">
            ...
            <span className="text-xs font-semibold text-slate-800 dark:text-slate-200">Figma</span>
          </div>
        </div>
